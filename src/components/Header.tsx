    ...
    <div>
      ...
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        <Link href="/home" className="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
          ...
          <Link href="/home" className="ml-3 text-xl">Beuty links</Link>
        </Link>
        <nav className="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center">
          ...
          <Link href="/deals" className="mr-5 hover:text-gray-900">Deals</Link>
          <Link href="/why-us" className="mr-5 hover:text-gray-900">Why Us</Link>
        </nav>
